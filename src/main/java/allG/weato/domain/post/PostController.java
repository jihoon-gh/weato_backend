...
import allG.weato.domain.post.dto.create.PostScrapDto;
import allG.weato.dto.*;
import allG.weato.domain.post.dto.create.CreatePostRequest;
import allG.weato.domain.post.dto.create.CreatePostResponse;
import allG.weato.domain.post.dto.retrieve.PostDetailRetrieveDto;
...
import allG.weato.domain.post.dto.update.UpdatePostResponse;
