...
import allG.weato.domain.comment.commentDto.update.UpdateCommentRequestDto;
...
import allG.weato.domain.comment.commentDto.update.UpdatedCommentResponseDto;
...
public class CommentsController {
    ...
    public UpdatedCommentResponseDto updateComment(@PathVariable("postId") Long postId, @PathVariable("commentId") Long commentId
            , @RequestBody UpdateCommentRequestDto request){
        Comment comment = commentService.findCommentById(commentId);
        commentService.updateComment(comment,request.getContent());
        return new UpdatedCommentResponseDto(comment);
    }
